  ...
  <html>
    ...
    <body>
	 ...
	 <main>
		...
		<div class="row">
		<div class="col s6 push-6" id="connect" style="display:none; margin:auto; width:50%"></div>
		<div class="col s6 pull-6" style="display:none; margin:auto; width:50%">LOOOL</div>
		</div>
		<div class="row" style="margin:auto;">
